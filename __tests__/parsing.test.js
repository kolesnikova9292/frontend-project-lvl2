...
import result3 from './__fixtures__/yaml/result.js'
  ...
  test.each([
    ['__tests__/__fixtures__/json/file1.json', '__tests__/__fixtures__/json/file2.json', 'stylish', resultStylish],
    ['__tests__/__fixtures__/json2/file1.json', '__tests__/__fixtures__/json2/file2.json', 'stylish', resultStylish1],
    ['__tests__/__fixtures__/yaml/file1.yaml', '__tests__/__fixtures__/yaml/file2.yaml', 'stylish', result3],
    ['__tests__/__fixtures__/json/file1.json', '__tests__/__fixtures__/json/file2.json', 'plain', resultPlain],
    ['__tests__/__fixtures__/json2/file1.json', '__tests__/__fixtures__/json2/file2.json', 'plain', resultPlain1]
...
test('parsing6', () => {
  const rez = genDiff('__tests__/__fixtures__/json/file1.json', '__tests__/__fixtures__/json/file2.json', 'json');
